...
//            System.out.println("3 Count Employees in Department");
...
public class App {
    public static void main(String[] args)  {
        ...
        do {
        	...
        	System.out.println("5. find employee by mobile");
        	System.out.println("6. find employees by salary");
            ...
            case 6: 
            	...
            	List<Employee> list5 = dao.findEmployeesBySalary(sc.nextInt());
